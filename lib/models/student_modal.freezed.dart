...
mixin _$Student {
  ...
  int? get streak =>
      throw _privateConstructorUsedError; // number of videos watched in a day
  int? get ilmPoints => throw _privateConstructorUsedError;
...
abstract class $StudentCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, String username, int? streak, int? ilmPoints});
}
    ...
    return _then(_value.copyWith(
      ...
      streak: freezed == streak
          ...
          : streak // ignore: cast_nullable_to_non_nullable
              as int?,
      ilmPoints: freezed == ilmPoints
          ? _value.ilmPoints
          : ilmPoints // ignore: cast_nullable_to_non_nullable
              as int?,
    ) as $Val);
  }
}
...
class _$_Student implements _Student {
  const _$_Student(
      {required this.uid, required this.username, this.streak, this.ilmPoints});
  ...
  @override
  final int? streak;
// number of videos watched in a day
  @override
  final int? ilmPoints;

  @override
  String toString() {
    return 'Student(uid: $uid, username: $username, streak: $streak, ilmPoints: $ilmPoints)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.ilmPoints, ilmPoints) ||
                other.ilmPoints == ilmPoints));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, uid, username, streak, ilmPoints);
...
abstract class _Student implements Student {
  const factory _Student(
      ...
      final int? streak,
      final int? ilmPoints}) = _$_Student;
  ...
  @override
  int? get streak;
  @override // number of videos watched in a day
  int? get ilmPoints;
  @override
  @JsonKey(ignore: true)
  _$$_StudentCopyWith<_$_Student> get copyWith =>
