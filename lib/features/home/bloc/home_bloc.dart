...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  HomeBloc({required this.service}) : super(HomeHasData(listOfPlaylist: [])) {
  ...
  FutureOr<void> _loadPlaylist(
    ...
    try {
      List<Playlist> listOfPlaylist =
          await service.fetchPlaylists(channelId: ChannelConstants.CHANNEL_ID);
  ...
  FutureOr<void> _loadMorePlaylist(
      HomeLoadMorePlaylist event, Emitter<HomeState> emit) async {
